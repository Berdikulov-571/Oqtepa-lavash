...
namespace OqTepaLavashProject
{
    public partial class PizzaPage : Form
    {
        ...
        private void PizzaPage_Load(object sender, EventArgs e)
        {
        ...
        private void button_woc7_Click(object sender, EventArgs e)
        {
            if (count1 > 0 || count2 > 0 || count3 > 0 || count4 > 0 || count5 > 0 || count6 > 0)
            {
                ...
                using (OqTepaContext contexts = new OqTepaContext())
                {
                    ...
                    if (count1 > 0)
                    {
                        zakaz.NameOfProduct = "Pizza qazili";
                        zakaz.NumOfProduct = count1.ToString();
                        zakaz.Price = 83000 * count1;
                ...
                using (OqTepaContext contexts = new OqTepaContext())
                {
                    ...
                    if (count2 > 0)
                    {
                        zakaz.NameOfProduct = "Pizza asarti";
                        zakaz.NumOfProduct = count2.ToString();
                        zakaz.Price = 78000 * count2;
                        zakaz.PhoneNumber = registrationPage.UserPhoneNumber;
                        contexts.Add(zakaz);
                        contexts.SaveChanges();
                    }
                ...
                using (OqTepaContext contexts = new OqTepaContext())
                {
                    ...
                    if (count3 > 0)
                    {
                        zakaz.NameOfProduct = "Pizza go'shtli";
                        zakaz.NumOfProduct = count3.ToString();
                        zakaz.Price = 78000 * count3;
                        zakaz.PhoneNumber = registrationPage.UserPhoneNumber;
                        contexts.Add(zakaz);
                        contexts.SaveChanges();
                    }
                ...
                using (OqTepaContext contexts = new OqTepaContext())
                {
                    ...
                    if (count4 > 0)
                    {
                        zakaz.NameOfProduct = "Pizza pepperoni";
                        zakaz.NumOfProduct = count4.ToString();
                        zakaz.Price = 69000 * count4;
                        zakaz.PhoneNumber = registrationPage.UserPhoneNumber;
                        contexts.Add(zakaz);
                        contexts.SaveChanges();
                    }
                ...
                using (OqTepaContext contexts = new OqTepaContext())
                {
                    ...
                    if (count5 > 0)
                    {
                        zakaz.NameOfProduct = "Pizza gribnaya";
                        zakaz.NumOfProduct = count5.ToString();
                        zakaz.Price = 67000 * count5;
                        zakaz.PhoneNumber = registrationPage.UserPhoneNumber;
                        contexts.Add(zakaz);
                        contexts.SaveChanges();
                    }
                ...
                using (OqTepaContext contexts = new OqTepaContext())
                {
                    ...
                    if (count6 > 0)
                    {
                        zakaz.NameOfProduct = "Pizza kurinnaya";
                        zakaz.NumOfProduct = count6.ToString();
                        zakaz.Price = 67000 * count6;
                        zakaz.PhoneNumber = registrationPage.UserPhoneNumber;
                        contexts.Add(zakaz);
                        contexts.SaveChanges();
                    }

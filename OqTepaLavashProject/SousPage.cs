...
{
    public partial class SousPage : Form
    {
        int count1 = 0;
        int count2 = 0;
        int count3 = 0;
        ...
        private void SousPage_Load(object sender, EventArgs e)
        {
        ...
        private void button_woc5_Click(object sender, EventArgs e)
        {
            if (count1 > 0 || count2 > 0 || count3 > 0 || count4 > 0)
            {
                using (OqTepaContext contexts = new OqTepaContext())
                {
                    ...
                    if (count1 > 0)
                    {
                        zakaz.NameOfProduct = "Ketchup";
                        zakaz.NumOfProduct = count1.ToString();
                        zakaz.Price = 2000 * count1;
                ...
                using (OqTepaContext contexts = new OqTepaContext())
                {
                    ...
                    if (count2 > 0)
                    {
                        zakaz.NameOfProduct = "Mayonez";
                        zakaz.NumOfProduct = count2.ToString();
                        zakaz.Price = 2000 * count2;
                        zakaz.PhoneNumber = registrationPage.UserPhoneNumber;
                        contexts.Add(zakaz);
                        contexts.SaveChanges();
                    }
                ...
                using (OqTepaContext contexts = new OqTepaContext())
                {
                    ...
                    if (count3 > 0)
                    {
                        zakaz.NameOfProduct = "Chili sous";
                        zakaz.NumOfProduct = count3.ToString();
                        zakaz.Price = 2000 * count3;
                        zakaz.PhoneNumber = registrationPage.UserPhoneNumber;
                        contexts.Add(zakaz);
                        contexts.SaveChanges();
                    }
                ...
                using (OqTepaContext contexts = new OqTepaContext())
                {
                    ...
                    if (count4 > 0)
                    {
                        zakaz.NameOfProduct = "Sirli sous";
                        zakaz.NumOfProduct = count4.ToString();
                        zakaz.Price = 2000 * count4;
                        zakaz.PhoneNumber = registrationPage.UserPhoneNumber;
                        contexts.Add(zakaz);
                        contexts.SaveChanges();
                    }

...
{
    public partial class XaggiAndClub : Form
    {
        int count1 = 0;
        int count2 = 0;
        public XaggiAndClub()
        ...
        private void XaggiAndClub_Load(object sender, EventArgs e)
        {
        ...
        private void button_woc3_Click(object sender, EventArgs e)
        {
            if (count1 > 0 || count2 > 0)
            {
                using (OqTepaContext contexts = new OqTepaContext())
                {
                    ...
                    if (count1 > 0)
                    {
                        zakaz.NameOfProduct = "Xaggi";
                        zakaz.NumOfProduct = count1.ToString();
                        zakaz.Price = 29000 * count1;
                ...
                using (OqTepaContext contexts = new OqTepaContext())
                {
                    ...
                    if (count2 > 0)
                    {
                        zakaz.NameOfProduct = "Clab sendvich";
                        zakaz.NumOfProduct = count2.ToString();
                        zakaz.Price = 27000 * count2;
                        zakaz.PhoneNumber = registrationPage.UserPhoneNumber;
                        contexts.Add(zakaz);
                        contexts.SaveChanges();
                    }

...
namespace OqTepaLavashProject
{
    public partial class Hamburger : Form
    {
        ...
        private void Hamburger_Load_1(object sender, EventArgs e)
        {
        ...
        private void button_woc7_Click(object sender, EventArgs e)
        {
            if (count1 > 0 || count2 > 0 || count3 > 0 || count4 > 0 || count5 > 0 || count6 > 0)
            {
                using (OqTepaContext contexts = new OqTepaContext())
                {
                    ...
                    if (count1 > 0)
                    {
                        zakaz.NameOfProduct = "Big Chizburger";
                        zakaz.NumOfProduct = count1.ToString();
                        zakaz.Price = count1 * 35000;
                ...
                using (OqTepaContext contexts = new OqTepaContext())
                {
                    ...
                    if (count2 > 0)
                    {
                        zakaz.NameOfProduct = "Big Burger";
                        zakaz.NumOfProduct = count2.ToString();
                        zakaz.Price = count2 * 31000;
                        zakaz.PhoneNumber = registrationPage.UserPhoneNumber;
                        contexts.Add(zakaz);
                        contexts.SaveChanges();
                    }
                ...
                using (OqTepaContext contexts = new OqTepaContext())
                {
                    ...
                    if (count3 > 0)
                    {
                        zakaz.NameOfProduct = "Big Doner";
                        zakaz.NumOfProduct = count3.ToString();
                        zakaz.Price = count3 * 25000;
                        zakaz.PhoneNumber = registrationPage.UserPhoneNumber;
                        contexts.Add(zakaz);
                        contexts.SaveChanges();
                    }
                ...
                using (OqTepaContext contexts = new OqTepaContext())
                {
                    ...
                    if (count4 > 0)
                    {
                        zakaz.NameOfProduct = "Chizburger";
                        zakaz.NumOfProduct = count4.ToString();
                        zakaz.Price = count4 * 23000;
                        zakaz.PhoneNumber = registrationPage.UserPhoneNumber;
                        contexts.Add(zakaz);
                        contexts.SaveChanges();
                    }
                ...
                using (OqTepaContext contexts = new OqTepaContext())
                {
                    ...
                    if (count5 > 0)
                    {
                        zakaz.NameOfProduct = "Gamburger";
                        zakaz.NumOfProduct = count5.ToString();
                        zakaz.Price = count5 * 21000;
                        zakaz.PhoneNumber = registrationPage.UserPhoneNumber;
                        contexts.Add(zakaz);
                        contexts.SaveChanges();
                    }
                ...
                using (OqTepaContext contexts = new OqTepaContext())
                {
                    ...
                    if (count6 > 0)
                    {
                        zakaz.NameOfProduct = "Shaurma";
                        zakaz.NumOfProduct = count6.ToString();
                        zakaz.Price = count6 * 21000;
                        zakaz.PhoneNumber = registrationPage.UserPhoneNumber;
                        contexts.Add(zakaz);
                        contexts.SaveChanges();
                    }

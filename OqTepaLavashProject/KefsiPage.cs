...
{
    public partial class KefsiPage : Form
    {
        int count1 = 0;
        int count2 = 0;
        int count3 = 0;
        ...
        private void KefsiPage_Load(object sender, EventArgs e)
        {
        ...
        private void button_woc5_Click(object sender, EventArgs e)
        {
            if (count1 > 0 || count2 > 0 || count3 > 0 || count4 > 0)
            {
                ...
                using (OqTepaContext contexts = new OqTepaContext())
                {
                    ...
                    if (count1 > 0)
                    {
                        zakaz.NameOfProduct = "Joja box";
                        zakaz.NumOfProduct = count1.ToString();
                        zakaz.Price = 23000 * count1;
                ...
                using (OqTepaContext contexts = new OqTepaContext())
                {
                    ...
                    if (count2 > 0)
                    {
                        zakaz.NameOfProduct = "Strips 5 sht";
                        zakaz.NumOfProduct = count2.ToString();
                        zakaz.Price = 18000 * count2;
                        zakaz.PhoneNumber = registrationPage.UserPhoneNumber;
                        contexts.Add(zakaz);
                        contexts.SaveChanges();
                    }
                ...
                using (OqTepaContext contexts = new OqTepaContext())
                {
                    ...
                    if (count3 > 0)
                    {
                        zakaz.NameOfProduct = "Strips 3 sht";
                        zakaz.NumOfProduct = count3.ToString();
                        zakaz.Price = 15000 * count3;
                        zakaz.PhoneNumber = registrationPage.UserPhoneNumber;
                        contexts.Add(zakaz);
                        contexts.SaveChanges();
                    }
                ...
                using (OqTepaContext contexts = new OqTepaContext())
                {
                    ...
                    if (count4 > 0)
                    {
                        zakaz.NameOfProduct = "Bayts";
                        zakaz.NumOfProduct = count4.ToString();
                        zakaz.Price = 13000 * count4;
                        zakaz.PhoneNumber = registrationPage.UserPhoneNumber;
                        contexts.Add(zakaz);
                        contexts.SaveChanges();
                    }
